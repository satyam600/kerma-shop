.jpg')}}"@extends("frontend.layouts.main");
			...
			<div class="breadcrumb-banner d-flex flex-wrap align-items-center justify-content-end">
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						<a href="{{url('lindex')}}">Home<span class="lnr lnr-arrow-right"></span></a>
					...
					<div class="row align-items-center">
						<div class="col-lg-6">
							<div class="quick-view-carousel">
								<div class="item" style="background: url({{url('frontend/img/organic-food/q1.jpg')}});">
